    ...
    class TutorialMain
    {
        static void Main(string[] args)
        {
            ...
            /*
                ...
                SollersAssignments.PalindromeChecker("madam");
                SollersAssignments.PalindromeChecker("A");
                SollersAssignments.PalindromeChecker("book");
                string name = "shane";
                ...
                DeskPhone JakesPhone = new DeskPhone();
